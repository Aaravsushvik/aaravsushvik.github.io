window.TRANSLATIONS = {
 en: {
   ...
   nav: { home: "Home", about: "About", projects: "Projects", learning: "Learning", certifications: "Certifications", contact: "Contact" },
   ...
   certifications: {
     ...
     c4: { title: "Applied AI Foundations", badge: "OpenAI Academy", date: "Issued September 14, 2026" },
     c5: { title: "Agents and Workflows", badge: "OpenAI Academy", date: "Issued September 14, 2026" },
     c6: { title: "Apply AI at Work Pathway Completion", badge: "OpenAI Academy", date: "Issued September 14, 2026" }
   },
   results: {
   ...
   footer: { text: "Learn deeply. Build thoughtfully. Question assumptions. • Built with semantic HTML, modern CSS, and vanilla JavaScript." }
 },
 te: {
   ...
   nav: { home: "హోమ్", about: "నా గురించి", projects: "ప్రాజెక్టులు", learning: "నేర్చుకుంటున్నవి", certifications: "సర్టిఫికేషన్లు", contact: "సంప్రదించండి" },
   ...
   certifications: {
     ...
     c4: { title: "Applied AI Foundations", badge: "OpenAI Academy", date: "సెప్టెంబర్ 14, 2026న జారీ చేయబడింది" },
     c5: { title: "Agents and Workflows", badge: "OpenAI Academy", date: "సెప్టెంబర్ 14, 2026న జారీ చేయబడింది" },
     c6: { title: "Apply AI at Work Pathway Completion", badge: "OpenAI Academy", date: "సెప్టెంబర్ 14, 2026న జారీ చేయబడింది" }
   },
   results: {
   ...
   footer: { text: "లోతుగా నేర్చుకోండి. ఆలోచనాత్మకంగా నిర్మించండి. ఊహలను ప్రశ్నించండి. • Semantic HTML, ఆధునిక CSS మరియు vanilla JavaScript‌తో నిర్మించబడింది." }
 },
 hi: {
   ...
   nav: { home: "होम", about: "मेरे बारे में", projects: "प्रोजेक्ट्स", learning: "सीखना", certifications: "प्रमाणपत्र", contact: "संपर्क" },
   ...
   certifications: {
     ...
     c4: { title: "Applied AI Foundations", badge: "OpenAI Academy", date: "14 सितंबर, 2026 को जारी किया गया" },
     c5: { title: "Agents and Workflows", badge: "OpenAI Academy", date: "14 सितंबर, 2026 को जारी किया गया" },
     c6: { title: "Apply AI at Work Pathway Completion", badge: "OpenAI Academy", date: "14 सितंबर, 2026 को जारी किया गया" }
   },
   results: {
   ...
   footer: { text: "गहराई से सीखें। सोच-समझकर बनाएँ। धारणाओं पर सवाल करें। • Semantic HTML, आधुनिक CSS और Vanilla JavaScript से बनाया गया।" }
 }
};