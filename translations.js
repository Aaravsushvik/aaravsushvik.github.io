window.TRANSLATIONS = {
  en: {
    page: { title: "Gadiparthi Sai Sushvik | Technology, AI & Governance" },
    skip: { link: "Skip to main content" },
    logo: { aria: "Gadiparthi Sai Sushvik Home" },
    nav: { home: "Home", about: "About", projects: "Projects", learning: "Learning", contact: "Contact" },
    ...
    about: {
      ...
      who: {
        ...
        p2: "My curiosity moves across artificial intelligence, web development, robotics, economics, political science, history, governance, and public policy. I enjoy exploring these different fields because many meaningful problems exist between disciplines rather than inside just one of them.",
    ...
    projects: {
      ...
      portfolio: {
        title: "Personal Portfolio Website", badge: "Web · Ongoing",
        description: "An evolving digital space for documenting my projects, experiments, interests, and learning journey.",
        li1: "Semantic HTML, modern CSS, and vanilla JavaScript.", li2: "Responsive design and accessibility-conscious interaction patterns.", li3: "Light and dark themes with saved and system preferences.", li4: "Multilingual content, structured metadata, and progressive web capabilities.", li5: "Offline support, SEO foundations, and performance-conscious design."
      },
      ui: {
        title: "Responsive UI Experiments", badge: "Frontend · Experimental",
        description: "Small experiments exploring responsive layouts, interaction design, accessibility, motion, and the relationship between visual simplicity and functional complexity.",
        li1: "Responsive layouts across different screen sizes.", li2: "Modern CSS architecture, custom properties, and fluid sizing.", li3: "Navigation and interaction experiments.", li4: "Accessibility-conscious interface patterns."
      },
      civic: {
        title: "Civic-Tech & Governance Notes", badge: "Research · Ongoing",
        description: "An evolving exploration of how technology interacts with government, institutions, policy, and everyday public life.",
        li1: "Digital governance and public-service delivery.", li2: "AI and public policy.", li3: "Accessibility and inclusive public systems.", li4: "Technology, institutions, and public systems."
      }
    },
    learning: {
      ...
      tag1: "Web Development", tag2: "JavaScript", tag3: "Responsive Design", tag4: "Web Accessibility", tag5: "Artificial Intelligence", tag6: "AI Tools & Prompting", tag7: "Robotics", tag8: "Emerging Technology", tag9: "Political Science", tag10: "Economics", tag11: "History", tag12: "Governance", tag13: "Public Policy", tag14: "Digital Governance", tag15: "Systems Thinking", tag16: "Research", tag17: "Critical Thinking"
    },
    skills: {
    ...
    favorites: {
      ...
      li1: "How will increasingly capable AI systems change the way people learn, work, create, govern, and make decisions?",
      li2: "How can technology make public systems simpler, more accessible, transparent, and effective?",
      li3: "What happens when intelligence moves from software into the physical world?",
      li4: "How should society respond when technology evolves faster than institutions?",
      li5: "What does it take to design technology that works for more people, rather than only for an assumed average user?",
      li6: "How do ideas, institutions, and decisions from the past shape the systems we live with today?",
      li7: "What can science and engineering teach us about the boundaries of human capability?",
      li8: "How do technologies, institutions, incentives, and people influence one another?"
    },
    contact: {
    ...
    form: {
      name: { label: "Full Name", placeholder: "Your full name", error: "Please enter your name." },
      email: { label: "Email Address", placeholder: "your@email.com", error: "Please enter a valid email address." },
      message: { label: "Message", placeholder: "What would you like to talk about?", error: "Please enter a message." },
      submit: "Send Message", sending: "Sending…", success: "Thanks — your message was sent.", failure: "Sorry, the message could not be sent. Please try again.",
      note: "Messages are processed through Formspree. Information you submit, along with technical data required to process the request, may be received by the service. I use submitted information to respond to your message."
    },
    top: { button: { label: "Scroll to top" } },
    footer: { text: "Learn deeply. Build thoughtfully. Question assumptions. • Built with semantic HTML, modern CSS, and vanilla JavaScript. • © 2026 Gadiparthi Sai Sushvik" }
  },
  te: {
    page: { title: "గదిపర్తి సాయి సుష్విక్ | టెక్నాలజీ, AI & గవర్నెన్స్" },
    skip: { link: "ప్రధాన కంటెంట్‌కు వెళ్లండి" },
    logo: { aria: "గదిపర్తి సాయి సుష్విక్ హోమ్" },
    nav: { home: "హోమ్", about: "నా గురించి", projects: "ప్రాజెక్టులు", learning: "నేర్చుకుంటున్నవి", contact: "సంప్రదించండి" },
    lang: { select: { label: "భాషను ఎంచుకోండి" } },
    share: { button: "ఈ పేజీని షేర్ చేయండి" },
    theme: { toDark: "డార్క్ మోడ్‌కు మార్చండి", toLight: "లైట్ మోడ్‌కు మార్చండి" },
    menu: { open: "నావిగేషన్ మెనూను తెరవండి", close: "నావిగేషన్ మెనూను మూసివేయండి" },
    command: { placeholder: "కమాండ్ టైప్ చేయండి..." },
    ...
    about: {
      ...
      who: {
        ...
        p2: "కృత్రిమ మేధస్సు, వెబ్ డెవలప్‌మెంట్, రోబోటిక్స్, ఎకనామిక్స్, పొలిటికల్ సైన్స్, హిస్టరీ, గవర్నెన్స్ మరియు పబ్లిక్ పాలసీ వంటి రంగాలలో నా ఆసక్తి కదులుతుంది. అత్యంత ముఖ్యమైన సమస్యలు ఒక్క రంగంలో కాకుండా రంగాల మధ్యనే ఉంటాయి కాబట్టి నేను ఈ విభిన్న రంగాలను అన్వేషించడం ఆనందిస్తాను.",
    ...
    results: {
      ...
      ssc: { title: "తెలంగాణ SSC · 2026" }, percentage: { title: "మొత్తం ఫలితం" },
    ...
    favorites: {
      ...
      li1: "మరింత సామర్థ్యం కలిగిన AI వ్యవస్థలు మనం నేర్చుకునే, పనిచేసే, సృష్టించే, పాలించే మరియు నిర్ణయాలు తీసుకునే విధానాలను ఎలా మారుస్తాయి?",
      li2: "ప్రజా వ్యవస్థలను మరింత సరళంగా, అందుబాటులో, పారదర్శకంగా మరియు సమర్థవంతంగా చేయడానికి టెక్నాలజీ ఎలా సహాయపడగలదు?",
      li3: "ఇంటెలిజెన్స్ సాఫ్ట్‌వేర్ నుండి భౌతిక ప్రపంచంలోకి వచ్చినప్పుడు ఏమి జరుగుతుంది?",
      li4: "టెక్నాలజీ సంస్థల కంటే వేగంగా అభివృద్ధి చెందినప్పుడు సమాజం ఎలా స్పందించాలి?",
      li5: "సగటు వినియోగదారుడిని మాత్రమే ఊహించకుండా ఎక్కువ మంది ప్రజలకు పనిచేసే టెక్నాలజీని రూపొందించడానికి ఏమి అవసరం?",
      li6: "గతంలోని ఆలోచనలు, సంస్థలు మరియు నిర్ణయాలు మనం నేడు జీవిస్తున్న వ్యవస్థలను ఎలా రూపొందిస్తాయి?",
      li7: "మానవ సామర్థ్యాల పరిమితుల గురించి సైన్స్ మరియు ఇంజినీరింగ్ మనకు ఏమి నేర్పగలవు?",
      li8: "టెక్నాలజీలు, సంస్థలు, ప్రోత్సాహకాలు మరియు ప్రజలు ఒకరినొకరు ఎలా ప్రభావితం చేసుకుంటాయి?"
    },
    contact: {
    ...
    form: {
      name: { label: "పూర్తి పేరు", placeholder: "మీ పూర్తి పేరు", error: "మీ పేరును నమోదు చేయండి." },
      email: { label: "ఈమెయిల్ చిరునామా", placeholder: "your@email.com", error: "చెల్లుబాటు అయ్యే ఈమెయిల్ నమోదు చేయండి." },
      message: { label: "సందేశం", placeholder: "మీరు ఏ విషయం గురించి మాట్లాడాలనుకుంటున్నారు?", error: "మీ సందేశాన్ని నమోదు చేయండి." },
      submit: "సందేశం పంపండి", sending: "పంపుతోంది…", success: "ధన్యవాదాలు — మీ సందేశం పంపబడింది.", failure: "క్షమించండి — సందేశం పంపలేకపోయాం. మళ్లీ ప్రయత్నించండి.",
      note: "సందేశాలు Formspree ద్వారా ప్రాసెస్ చేయబడతాయి. మీరు సమర్పించిన సమాచారం మరియు అభ్యర్థనను ప్రాసెస్ చేయడానికి అవసరమైన సాంకేతిక డేటాను ఆ సేవ స్వీకరించవచ్చు. మీ సందేశానికి స్పందించడానికి సమర్పించిన సమాచారాన్ని ఉపయోగిస్తాను."
    },
    top: { button: { label: "పైకి స్క్రోల్ చేయండి" } },
    footer: { text: "లోతుగా నేర్చుకోండి. ఆలోచనాత్మకంగా నిర్మించండి. ఊహలను ప్రశ్నించండి. • Semantic HTML, ఆధునిక CSS మరియు vanilla JavaScript‌తో నిర్మించబడింది. • © 2026 Gadiparthi Sai Sushvik" }
  },
  hi: {
    page: { title: "गदिपर्थी साई सुष्विक | Technology, AI & Governance" },
    skip: { link: "मुख्य सामग्री पर जाएँ" },
    logo: { aria: "गदिपर्थी साई सुष्विक होम" },
    nav: { home: "होम", about: "मेरे बारे में", projects: "प्रोजेक्ट्स", learning: "सीखना", contact: "संपर्क" },
    lang: { select: { label: "भाषा चुनें" } },
    share: { button: "यह पेज साझा करें" },
    theme: { toDark: "डार्क मोड पर जाएँ", toLight: "लाइट मोड पर जाएँ" },
    menu: { open: "नेविगेशन मेनू खोलें", close: "नेविगेशन मेनू बंद करें" },
    command: { placeholder: "कमांड लिखें..." },
    ...
    about: {
      ...
      who: {
        ...
        p2: "मेरी जिज्ञासा आर्टिफिशियल इंटेलिजेंस, वेब डेवलपमेंट, रोबोटिक्स, अर्थशास्त्र, राजनीतिक विज्ञान, इतिहास, शासन और सार्वजनिक नीति तक फैली हुई है। मैं इन विभिन्न क्षेत्रों को समझना पसंद करता हूँ क्योंकि कई सार्थक समस्याएँ किसी एक विषय के अंदर नहीं, बल्कि उनके बीच मौजूद होती हैं।",
    ...
    results: {
      ...
      ssc: { title: "तेलंगाना SSC · 2026" }, percentage: { title: "कुल परिणाम" },
    ...
    favorites: {
      ...
      li1: "अधिक सक्षम AI सिस्टम लोगों के सीखने, काम करने, बनाने, शासन करने और निर्णय लेने के तरीकों को कैसे बदलेंगे?",
      li2: "तकनीक सार्वजनिक प्रणालियों को अधिक सरल, सुलभ, पारदर्शी और प्रभावी कैसे बना सकती है?",
      li3: "जब intelligence software से निकलकर physical world में पहुँचती है तो क्या होता है?",
      li4: "जब तकनीक संस्थाओं से तेज़ी से विकसित होती है तो समाज को कैसे प्रतिक्रिया देनी चाहिए?",
      li5: "ऐसी तकनीक बनाने के लिए क्या आवश्यक है जो केवल किसी औसत उपयोगकर्ता के लिए नहीं बल्कि अधिक से अधिक लोगों के लिए काम करे?",
      li6: "अतीत के विचार, संस्थाएँ और निर्णय आज हमारे आसपास की प्रणालियों को कैसे आकार देते हैं?",
      li7: "मानव क्षमता की सीमाओं के बारे में विज्ञान और इंजीनियरिंग हमें क्या सिखा सकते हैं?",
      li8: "तकनीक, संस्थाएँ, प्रोत्साहन और लोग एक-दूसरे को कैसे प्रभावित करते हैं?"
    },
    contact: {
    ...
    form: {
      name: { label: "पूरा नाम", placeholder: "अपना पूरा नाम", error: "कृपया अपना नाम दर्ज करें।" },
      email: { label: "ईमेल पता", placeholder: "your@email.com", error: "कृपया सही ईमेल पता दर्ज करें।" },
      message: { label: "संदेश", placeholder: "आप किस विषय पर बात करना चाहते हैं?", error: "कृपया अपना संदेश दर्ज करें।" },
      submit: "संदेश भेजें", sending: "भेजा जा रहा है…", success: "धन्यवाद — आपका संदेश भेज दिया गया है।", failure: "क्षमा करें — संदेश नहीं भेजा जा सका। फिर से प्रयास करें।",
      note: "संदेश Formspree के माध्यम से प्रोसेस किए जाते हैं। आपके द्वारा दी गई जानकारी और अनुरोध को प्रोसेस करने के लिए आवश्यक तकनीकी डेटा सेवा द्वारा प्राप्त किया जा सकता है। आपके संदेश का उत्तर देने के लिए दी गई जानकारी का उपयोग किया जाता है।"
    },
    top: { button: { label: "ऊपर जाएँ" } },
    footer: { text: "गहराई से सीखें। सोच-समझकर बनाएँ। धारणाओं पर सवाल करें। • Semantic HTML, आधुनिक CSS और Vanilla JavaScript से बनाया गया। • © 2026 Gadiparthi Sai Sushvik" }
  }
};